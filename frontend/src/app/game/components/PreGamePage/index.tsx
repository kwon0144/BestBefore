...
export default function PreGamePage({
  ...
  return (
    <div className="-mt-20"> {/* Negative top margin to connect with nav */}
      {/* Top Section - Full Width Banner */}
      <motion.div
        initial={{ y: -50, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 1, ease: "easeOut" }}
        className="w-full bg-white bg-opacity-70 backdrop-filter backdrop-blur-sm mb-8 shadow-md pt-24 pb-14"
        style={{
      ...
      >
        <div className="max-w-3xl mx-auto flex flex-col justify-center items-center text-green-800 px-4 py-4">
          <h1 className="text-4xl font-bold mb-4 text-center">Food Waste Game</h1>
          <p className="text-lg font-semibold text-center">
            Learn to sort food waste correctly and reduce environmental impact through fun gameplay
          </p>
        </div>
      </motion.div>
