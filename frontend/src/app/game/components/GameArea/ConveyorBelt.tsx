...
export default function ConveyorBelt({ resources }: ConveyorBeltProps) {
  // Now correctly accepting the resources parameter
  
  return (
    <>
      {/* Top horizontal section (left to right) */}
      <div className="absolute top-[260px] left-[50px] right-[70px] h-[50px] bg-gray-400 border-t-2 border-b-2 border-l-2 border-r-2 border-gray-600">
      ...
      <div className="absolute top-[280px] right-[70px] w-[60px] h-[250px] bg-gray-400 border-l-2 border-r-2 border-gray-600">
